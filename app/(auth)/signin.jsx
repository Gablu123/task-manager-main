...
const Signin = () => {
  ...
  const handleLogin = async () => {
    ...
    if (res.meta.requestStatus === "fulfilled") {
      ...
      Alert.alert("Error", res.payload || "Invalid credentials");
    }
  };
    ...
    <ThemeView style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.welcomeSection}>
          ...
          <ThemeText style={styles.subtitle}>Sign in to pick up right where you left off</ThemeText>
        </View>
        ...
        <View style={styles.form}>
          ...
          <ThemeText style={styles.inputLabel}>Password</ThemeText>
        ...
        <View style={styles.actionSection}>
          ...
          >
            <ThemeText style={[styles.linkText, { color: isDark ? "#4DA3FF" : "#007AFF" }]}>
              Don't have an account? <ThemeText style={styles.boldLink}>Sign Up</ThemeText>
            </ThemeText>
          </Pressable>
        </View>
      </View>
